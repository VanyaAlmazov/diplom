...
const MovieDetails = () => {
  ...
  const { id } = useParams();
  const url = `https://api.themoviedb.org/3/movie/${id}?api_key=1c98e893bed1d8a94d7c24b73df2860f`;
  const urlRecomendation = `https://api.themoviedb.org/3/movie/${id}/recommendations?api_key=1c98e893bed1d8a94d7c24b73df2860f`;
